...
* Player's score per fruit chain now goes up exponentially based on the length of the chain
	...
	* This means that around 1-5 fruits connected it goes by a linear equation (5x), but chains beyond that length increase their points exponentially
	* The maximum score a chain can achieve is 1000 points, or around 9+ fruits
